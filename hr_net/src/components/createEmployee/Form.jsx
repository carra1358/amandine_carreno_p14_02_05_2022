...
function Form() {
    ...
    return (
        <>
            ...
            <Modal isOpen={isValid} size="M" handleClose={() => setIsValid(false)} customButtonShow={false} underlayerHeight={"100%"}><p className="modal_message"> Employee Created </p></Modal>
        </>
    )
